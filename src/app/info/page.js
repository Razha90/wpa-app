      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="bg-white shadow-lg rounded-2xl p-8 max-w-lg text-center">
          ...
          <div className="flex flex-row items-center gap-x-2">
            <Image width={60} height={100} src={'/tut-wuri-handayani.png'} alt="Tut Wuri Handayani"/>
            <Image width={60} height={100} src={'/diktisaintek.png'} alt="Dikti Saintek"/>
            <Image width={400} height={100} src={'/lppm.png'} alt="LPPM" />
